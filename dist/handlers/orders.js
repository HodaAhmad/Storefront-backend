...
var create = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var order, createdOrder, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
var getUserOrders = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userID, userOrders, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.getUserOrders(userID)];
            case 2:
                userOrders = _a.sent();
                res.json(userOrders);
                return [3 /*break*/, 4];
